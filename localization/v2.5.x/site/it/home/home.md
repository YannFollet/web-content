...
<ul>
<li>Added guidance on how to <a href="/docs/it/full-text-search.md">conduct full text search</a>.</li>
<li>Added guidance on how to <a href="/docs/it/keyword-match.md">conduct text match</a>.</li>
<li>Added guidance on how to <a href="/docs/it/nullable-and-default.md">enable nullable and default values</a>.</li>
<li>Added descriptions of <a href="/docs/it/analyzer-overview.md">analyzers</a>.</li>
<li>Added descriptions of <a href="/docs/it/bitmap.md">bitmap indexes</a>.</li>
</ul>
</div>
