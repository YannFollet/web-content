...
<h2 id="Enable-dynamic-field​" class="common-anchor-header">Enable dynamic field​<button data-href="#Enable-dynamic-field​" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Collections created using the method described in <a href="/docs/it/create-collection-instantly.md">​Create Collection Instantly</a> have the dynamic field enabled by default. You can also enable the dynamic field manually when creating a collection with custom settings.​</p>
