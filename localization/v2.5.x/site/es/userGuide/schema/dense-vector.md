...
<p>Milvus supports other index types as well. For more details, refer to <a href="https://milvus.io/docs/index.md?tab=floating">​Floating Vector Indexes</a>. Additionally, Milvus supports other metric types. For more information, refer to <a href="/docs/es/metric.md">​Metric Types</a>.​</p>
