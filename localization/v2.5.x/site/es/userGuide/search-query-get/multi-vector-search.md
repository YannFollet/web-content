...
<p>For more details, refer to <a href="/docs/es/sparse_vector.md">​Sparse Vector</a> and <a href="/docs/es/dense-vector.md">​Dense Vector</a>.​</p>
...
<button class="copy-code-btn"></button></code></pre>
<p>During sparse vector searches, you can simplify the process of generating sparse embedding vectors by leveraging Full Text Search capabilities. For more details, see <a href="/docs/es/full-text-search.md">​Full Text Search</a>.​</p>
...
<p>For more details about the mechanisms of these two reranking strategies, refer to <a href="/docs/es/reranking.md">​Reranking</a>.​</p>
