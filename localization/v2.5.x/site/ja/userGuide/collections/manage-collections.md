...
<p>For more information about searches and queries, refer to the articles in the <a href="/docs/ja/single-vector-search.md">​Search &amp; Rerank</a> chapter, among which, basic features are:​</p>
<ul>
...
<p>For details on these consistency levels, refer to <a href="/docs/ja/consistency.md">​Consistency Level</a>.​</p>
<h2 id="Limits​" class="common-anchor-header">Limits​<button data-href="#Limits​" class="anchor-icon" translate="no">
    ...
    </button></h2><p>For limits and restrictions on collections, refer to <a href="/docs/ja/limitations.md">​Limits &amp; Restrictions</a>.​</p>
