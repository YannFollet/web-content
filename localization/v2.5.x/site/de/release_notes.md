...
<p>For details, refer to <a href="/docs/de/analyzer-overview.md">Analyzer Overview</a> and <a href="/docs/de/full-text-search.md">Full Text Search</a>.</p>
...
<p>For details, refer to <a href="/docs/de/analyzer-overview.md">Analyzer Overview</a> and <a href="/docs/de/keyword-match.md">Text Match</a>.</p>
...
<p>For details, refer to <a href="/docs/de/bitmap.md">Bitmap Index</a>.</p>
...
<p>For details, refer to <a href="/docs/de/nullable-and-default.md">Nullable &amp; Default Value</a>.</p>
...
<p>For details, refer to <a href="/docs/de/clustering-compaction.md">Clustering Compaction</a>.</p>
...
<p>For users who already have a working Milvus deployment, you need to upgrade the ETCD and Pulsar components before you can use the new features and functions. For details, refer to <a href="/docs/de/upgrade-pulsar-v3.md">Upgrade Pulsar from 2.x to 3.x</a></p>
