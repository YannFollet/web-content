...
<ul>
<li>Added guidance on how to <a href="/docs/de/full-text-search.md">conduct full text search</a>.</li>
<li>Added guidance on how to <a href="/docs/de/keyword-match.md">conduct text match</a>.</li>
<li>Added guidance on how to <a href="/docs/de/nullable-and-default.md">enable nullable and default values</a>.</li>
<li>Added descriptions of <a href="/docs/de/analyzer-overview.md">analyzers</a>.</li>
<li>Added descriptions of <a href="/docs/de/bitmap.md">bitmap indexes</a>.</li>
</ul>
</div>
