...
<ul>
<li><p>For vector fields of the <code translate="no">SPARSE_FLOAT_VECTOR</code> type, use the <code translate="no">BM25</code> metric type only when performing full text search. For more information, refer to <a href="/docs/de/full-text-search.md">​Full Text Search</a>.​</p></li>
