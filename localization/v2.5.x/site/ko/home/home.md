...
<ul>
<li>Added guidance on how to <a href="/docs/ko/full-text-search.md">conduct full text search</a>.</li>
<li>Added guidance on how to <a href="/docs/ko/keyword-match.md">conduct text match</a>.</li>
<li>Added guidance on how to <a href="/docs/ko/nullable-and-default.md">enable nullable and default values</a>.</li>
<li>Added descriptions of <a href="/docs/ko/analyzer-overview.md">analyzers</a>.</li>
<li>Added descriptions of <a href="/docs/ko/bitmap.md">bitmap indexes</a>.</li>
</ul>
</div>
