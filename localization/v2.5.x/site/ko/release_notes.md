...
<p>For details, refer to <a href="/docs/ko/analyzer-overview.md">Analyzer Overview</a> and <a href="/docs/ko/full-text-search.md">Full Text Search</a>.</p>
...
<p>For details, refer to <a href="/docs/ko/analyzer-overview.md">Analyzer Overview</a> and <a href="/docs/ko/keyword-match.md">Text Match</a>.</p>
...
<p>For details, refer to <a href="/docs/ko/bitmap.md">Bitmap Index</a>.</p>
...
<p>For details, refer to <a href="/docs/ko/nullable-and-default.md">Nullable &amp; Default Value</a>.</p>
...
<p>For details, refer to <a href="/docs/ko/clustering-compaction.md">Clustering Compaction</a>.</p>
...
<p>For users who already have a working Milvus deployment, you need to upgrade the ETCD and Pulsar components before you can use the new features and functions. For details, refer to <a href="/docs/ko/upgrade-pulsar-v3.md">Upgrade Pulsar from 2.x to 3.x</a></p>
