...
<p>For details, refer to <a href="/docs/fr/analyzer-overview.md">Analyzer Overview</a> and <a href="/docs/fr/full-text-search.md">Full Text Search</a>.</p>
...
<p>For details, refer to <a href="/docs/fr/analyzer-overview.md">Analyzer Overview</a> and <a href="/docs/fr/keyword-match.md">Text Match</a>.</p>
...
<p>For details, refer to <a href="/docs/fr/bitmap.md">Bitmap Index</a>.</p>
...
<p>For details, refer to <a href="/docs/fr/nullable-and-default.md">Nullable &amp; Default Value</a>.</p>
...
<p>For details, refer to <a href="/docs/fr/clustering-compaction.md">Clustering Compaction</a>.</p>
...
<p>For users who already have a working Milvus deployment, you need to upgrade the ETCD and Pulsar components before you can use the new features and functions. For details, refer to <a href="/docs/fr/upgrade-pulsar-v3.md">Upgrade Pulsar from 2.x to 3.x</a></p>
