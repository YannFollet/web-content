...
<button class="copy-code-btn"></button></code></pre>
<p>In addition to <code translate="no">AUTOINDEX</code>, you can specify other scalar index types like <code translate="no">INVERTED</code> or <code translate="no">BITMAP</code>. For supported index types, refer to <a href="/docs/fr/index-scalar-fields.md">​Scalar Indexes</a>.​</p>
