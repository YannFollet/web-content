...
<ul>
<li>Added guidance on how to <a href="/docs/ja/multi-vector-search.md">conduct hybrid search</a>.</li>
<li>Added description of <a href="/docs/ja/gpu_index.md">GPU index</a>.</li>
<li>Added guidance on how to <a href="/docs/ja/embeddings.md">embed your data using PyMilvus</a>.</li>
<li>Added descriptions of <a href="/docs/ja/milvus-cdc-overview.md">Milvus CDC</a>.</li>
</ul>
</div>
