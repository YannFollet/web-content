...
<p>To apply the above changes to your Milvus cluster, please follow the steps in <a href="/docs/ja/configure-helm.md">Configure Milvus with Helm</a> and <a href="/docs/ja/configure_operator.md">Configure Milvus with Milvus Operators</a>.</p>
