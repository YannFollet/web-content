...
<ul>
<li>Added guidance on how to <a href="/docs/es/multi-vector-search.md">conduct hybrid search</a>.</li>
<li>Added description of <a href="/docs/es/gpu_index.md">GPU index</a>.</li>
<li>Added guidance on how to <a href="/docs/es/embeddings.md">embed your data using PyMilvus</a>.</li>
<li>Added descriptions of <a href="/docs/es/milvus-cdc-overview.md">Milvus CDC</a>.</li>
</ul>
</div>
