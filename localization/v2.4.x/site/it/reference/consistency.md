...
<p>Milvus supports four consistency levels:  strong, bounded staleness, session, and eventually. The default consistency level in Milvus is bounded staleness.  You can easily tune the consistency level when conducting a <a href="/docs/it/single-vector-search.md">single-vector search</a>, <a href="/docs/it/multi-vector-search.md">hybrid search</a> or <a href="/docs/it/get-and-scalar-query.md">query</a> to make it best suit your application.</p>
...
<ul>
<li><a href="/docs/it/single-vector-search.md">conducting a single-vector search</a></li>
<li><a href="/docs/it/multi-vector-search.md">conducting a hybrid search</a></li>
<li><a href="/docs/it/get-and-scalar-query.md">conducting a scalar query</a></li>
</ul></li>
</ul>
