...
<ul>
<li>Learn how to conduct a <a href="/docs/it/multi-vector-search.md">Hybrid Search</a>.</li>
...
<li>Learn how to <a href="/docs/it/enable-dynamic-field.md">use dynamic fields in building boolean expressions</a>.</li>
</ul>
