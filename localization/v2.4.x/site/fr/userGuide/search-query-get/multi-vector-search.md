...
<p>For more information about reranking strategies, refer to <a href="/docs/fr/reranking.md">Reranking</a>.</p></li>
<li><p><code translate="no">limit</code> (<em>int</em>)</p>
