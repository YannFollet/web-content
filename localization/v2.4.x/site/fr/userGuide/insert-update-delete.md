...
<li><p>You have created a collection. To create a collection, refer to <a href="/docs/fr/manage-collections.md">Manage Collections</a>.</p></li>
...
<span class="hljs-comment">// </span>
<button class="copy-code-btn"></button></code></pre>
<p>The output is a dictionary containing the statistics on the affected entities. For details on partition operations, refer to <a href="/docs/fr/manage-partitions.md">Manage Partitions</a>.</p>
...
<span class="hljs-comment">// </span>
<button class="copy-code-btn"></button></code></pre>
<p>For details on how to use filter expressions, refer to <a href="/docs/fr/get-and-scalar-query.md">Get &amp; Scalar Query</a>.</p></li>
