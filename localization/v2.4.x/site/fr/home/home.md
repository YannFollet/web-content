...
<ul>
<li>Added guidance on how to <a href="/docs/fr/multi-vector-search.md">conduct hybrid search</a>.</li>
<li>Added description of <a href="/docs/fr/gpu_index.md">GPU index</a>.</li>
<li>Added guidance on how to <a href="/docs/fr/embeddings.md">embed your data using PyMilvus</a>.</li>
<li>Added descriptions of <a href="/docs/fr/milvus-cdc-overview.md">Milvus CDC</a>.</li>
</ul>
</div>
