...
<ul>
<li><a href="https://github.com/zilliztech/milvus-migration">Milvus-migration</a> tool. For installation details, refer to <a href="/docs/zh/milvusdm_install.md">Install Migration Tool</a>.</li>
</ul></li>
...
<tr><td><code translate="no">source.milvus2x.username</code></td><td>Username for the source Milvus server. This parameter is required if user authentication is enabled for your Milvus server. For more information, refer to <a href="/docs/zh/authenticate.md">Enable Authentication</a>.</td></tr>
<tr><td><code translate="no">source.milvus2x.password</code></td><td>Password for the source Milvus server. This parameter is required if user authentication is enabled for your Milvus server. For more information, refer to <a href="/docs/zh/authenticate.md">Enable Authentication</a>.</td></tr>
</tbody>
</table>
</li>
...
<tr><td><code translate="no">target.milvus2x.username</code></td><td>Username for the target Milvus server. This parameter is required if user authentication is enabled for your Milvus server. For more information, refer to <a href="/docs/zh/authenticate.md">Enable Authentication</a>.</td></tr>
<tr><td><code translate="no">target.milvus2x.password</code></td><td>Password for the target Milvus server. This parameter is required if user authentication is enabled for your Milvus server. For more information, refer to <a href="/docs/zh/authenticate.md">Enable Authentication</a>.</td></tr>
</tbody>
</table>
</li>
</ul>
