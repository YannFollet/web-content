...
<ul>
<li>Learn how to conduct a <a href="/docs/zh/multi-vector-search.md">Hybrid Search</a>.</li>
...
<li>Learn how to <a href="/docs/zh/enable-dynamic-field.md">use dynamic fields in building boolean expressions</a>.</li>
</ul>
